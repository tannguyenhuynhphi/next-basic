...
import { Badge, Button, Card, Image, Pagination } from "antd";
...
const ProductList = (props) => {
  ...
  useEffect(() => {
    ...
    productService.getProduct(limit, skip).then((x) => {
      setData(x.data);
      setTotal(x.total);
    });
  }, []);
  ...
  return (
    <>
        ...
        {data &&
          data.map((item) => (
            <Card.Grid style={gridStyle}>
              ...
              <Image
                src={item.imageUrl ? item.imageUrl : "error"}
              ...
              <div className={classes.productFooter}>
                <div className={classes.productbutton}>
                  <Button type="dashed" onClick={() => onDetail(item._id)}>
                    Chi tiết
                  </Button>
                </div>
                <div className={classes.productbutton}>
      ...
      <div className={classes.paginationProduct}>
        <Pagination
          pageSize={12}
          current={page}
